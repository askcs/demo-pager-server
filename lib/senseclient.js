            ...
            if(err) {
                ...
                commonSense.sensors(function(err, res) {
                    ...
                    if(sc.gps!=null && sc.active!=null) {
                        ...
                        var data = {"sensor":{"name":"position","display_name":"position","device_type":"position","data_type":"json","data_structure":"{\"longitude\":\"float\",\"latitude\":\"float\",\"accuracy\":\"float\"}"}};
...
SenseClient.prototype.addGPSData = function(lat, long, accuracy, callback) {
    ...
    var data = {"data":[{"value":"{\"latitude\":"+lat+",\"longitude\":"+long+",\"accuracy\":"+accuracy+"}","date":now}]};
...
SenseClient.prototype.addActiveData = function(value, callback) {
    var sc = this;
    var now = (new Date().getTime() / 1000);
    var data = {"data":[{"value":value,"date":now}]};
    this.login.then(function() {
