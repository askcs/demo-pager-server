...
FrameFactory.prototype.createAvailability = function(frameNumber, notification, state, permenantConnection) {

    var frameType = "E";
    var frame = frameType;
    frame += padLeft(frameNumber,2); // Add frameNumber with leading zeros
    frame += padLeft(notification,2);
    frame += padLeft(state,2);
